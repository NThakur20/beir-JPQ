...
#### PREPROCESSING ####
for dataset in cqadupstack/mathematica cqadupstack/gaming cqadupstack/gis cqadupstack/physics cqadupstack/programmers cqadupstack/stats cqadupstack/tex cqadupstack/unix cqadupstack/webmasters cqadupstack/wordpress cqadupstack/android cqadupstack/english
do
    export PREFIX=gen
    ...
    ### TRAIN ####
    CUDA_VISIBLE_DEVICES=${cudaNum} OMP_NUM_THREADS=6 python -m jpq.run_train_gpl \
        --preprocess_dir /home/ukp/thakur/projects/JPQ/preprocess/${dataset} \
        --model_save_dir /home/ukp/thakur/projects/JPQ/final_models/${dataset}/gpl \
        ...
        --max_seq_length 64 \
        --loss_neg_topK 25 \
        --data_path /home/ukp/thakur/projects/JPQ/datasets/${dataset} \
        --hard_negative_jsonl /home/ukp/thakur/projects/JPQ/datasets/${dataset}/hard_negatives.jsonl
    ...
    CUDA_VISIBLE_DEVICES=${cudaNum} OMP_NUM_THREADS=6 python -m jpq.eval_beir \
        ...
        --prefix "jpq-gpl-32x-compression"
done